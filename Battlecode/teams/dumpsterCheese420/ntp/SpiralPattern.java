...
public class SpiralPattern extends NoiseTowerPattern {
	...
	public SpiralPattern(RobotController t, int r) {
		tower = t;
	...
	public SpiralPattern(RobotController t, int r, MapLocation center) {
		tower = t;
		fireOrder = new ArrayList<MapLocation>();
		shootPosition = 0;
		this.center = center;
	...
	// Initializer which sets center to tower location
	public SpiralPattern(RobotController t, int r, int vel) {
		tower = t;
		fireOrder = new ArrayList<MapLocation>();
		shootPosition = 0;
		center = t.getLocation();
	...
	// Initializer which takes center as input
	public SpiralPattern(RobotController t, int r, MapLocation center, int vel) {
		tower = t;
		fireOrder = new ArrayList<MapLocation>();
		shootPosition = 0;
		this.center = center;
