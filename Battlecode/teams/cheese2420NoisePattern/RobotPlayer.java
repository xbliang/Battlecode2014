...
//		if (newNoiseTowerPattern == null) {
//			int pastr = rc.readBroadcast(PASTR_LOCATION_CHANNEL);
//			if (pastr != 0)
////				newNoiseTowerPattern = new BFSCirclePattern(rc, 150, Util.intToLoc(pastr));
//				noiseTowerPattern = new BFSCirclePattern(rc, 150, Util.intToLoc(pastr));
//		} 
////		else {
////			while (Clock.getBytecodesLeft() > 270 && !BFSCirclePattern.doneSearching) {
//////				System.out.println(i - Clock.getBytecodesLeft());
//////				i = Clock.getBytecodesLeft();
////				newNoiseTowerPattern.searchStep();
////			}
////			if (BFSCirclePattern.doneSearching) {
////				noiseTowerPattern = newNoiseTowerPattern;
////			}
////		}
	}
...
//		noiseTowerPattern = new BFSCirclePatternWithBackup(rc, 150, new LinearPattern(rc, 17));
		noiseTowerPattern = new SpiralPatternReachable(rc, 17);
//		noiseTowerPattern = new LinearSpiralReachableAlternatingPattern(rc, 17);
	}
