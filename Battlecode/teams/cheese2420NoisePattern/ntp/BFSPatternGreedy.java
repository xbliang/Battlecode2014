...
public class BFSPatternGreedy extends NoiseTowerPattern {
	...
	public BFSPatternGreedy(RobotController t, int range, MapLocation center) throws GameActionException {
		tower = t;
		this.center = center;
		this.range = range;
	...
	public void shootNext() throws GameActionException {
		if (tower.isActive()) {
			...
			bestLoc = mostCowsWithinDonutSq(9, range, 200);
		}
	}
