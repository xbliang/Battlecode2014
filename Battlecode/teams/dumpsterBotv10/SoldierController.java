...
//	private static int retreatRequestLooks[] = new int[]{3,4,5};
...
/*	private static MapLocation averageRobotLocation(RobotInfo[] robots) {
	...
	public static double rateMove(MapLocation loc) {
		...
		if(oldDist>17 && dist>17) {
			return oldDist-dist-(10*adjacentRobots(loc, friendlySoldiers, numFriendlySoldiers));
		}
