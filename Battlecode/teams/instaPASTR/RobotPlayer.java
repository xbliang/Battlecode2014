...
public class RobotPlayer {
	...
	private static void runNoiseTower() throws GameActionException {
		rc.broadcast(NOISE_BUILD_CHANNEL, Clock.getRoundNum()+5);
	...
	private static void initNoiseTower() throws GameActionException {
		noiseTowerPattern = new SpiralPatternReachable(rc,12,5);
	}
	...
	private static void initHQ() throws GameActionException {
		...
		rc.broadcast(NOISE_BUILD_CHANNEL, 200);
		rc.broadcast(PASTR_BUILD_CHANNEL, 250);
